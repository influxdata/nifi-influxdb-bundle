...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|
| [nifi-influx-database-nar-1.31.0-SNAPSHOT.nar](https://github.com/influxdata/nifi-influxdb-bundle/releases/download/v1.31.0-SNAPSHOT/nifi-influx-database-nar-1.31.0-SNAPSHOT.nar) | 1.27.0       |
| [nifi-influx-database-nar-1.30.0.nar](https://github.com/influxdata/nifi-influxdb-bundle/releases/download/v1.30.0/nifi-influx-database-nar-1.30.0.nar)                            | 1.27.0       |
| [nifi-influx-database-nar-1.29.0.nar](https://github.com/influxdata/nifi-influxdb-bundle/releases/download/v1.29.0/nifi-influx-database-nar-1.29.0.nar)                            | 1.26.0       |
