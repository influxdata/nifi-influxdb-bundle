...
public class ITPutInfluxDatabaseRecord extends AbstractITInfluxDB {


    private MockRecordParser recordReader;
    private PutInfluxDatabaseRecord processor;
    ...
    public void setUp() throws Exception {
        ...
        processor = new PutInfluxDatabaseRecord();
    ...
    public void parallelRunningProcessor() throws InitializationException {
        ...
        runner.assertTransferCount(PutInfluxDatabaseRecord.REL_SUCCESS, count);
