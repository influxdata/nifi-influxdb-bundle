...
public class TestPutInfluxDatabaseRecord extends AbstractTestPutInfluxDatabaseRecord {
    ...
    public void addNullField() {
        ...
        testRunner.assertAllFlowFilesTransferred(PutInfluxDatabaseRecord.REL_SUCCESS, 1);
    ...
    public void addArrayFieldIgnore() {
        ...
        addFieldByType(new Object[]{25L, 55L}, null, dataType, false, PutInfluxDatabaseRecord.REL_SUCCESS);
    }
    ...
    public void addArrayTagIgnore() {
        ...
        addTagByType(new Object[]{25L, 55L}, null, dataType, false, PutInfluxDatabaseRecord.REL_SUCCESS);
    }
    ...
    public void nullValueBehaviourIgnoredTag() {
        ...
        List<MockFlowFile> flowFiles = testRunner.getFlowFilesForRelationship(PutInfluxDatabaseRecord.REL_SUCCESS);
    ...
    public void nullValueBehaviourFailTag() {
        ...
        List<MockFlowFile> flowFiles = testRunner.getFlowFilesForRelationship(PutInfluxDatabaseRecord.REL_FAILURE);
        Assert.assertEquals(1, flowFiles.size());

        Assert.assertEquals("Cannot write FlowFile to InfluxDB because the field 'nifi-not-exist-tag' has null value.",
                flowFiles.get(0).getAttribute(PutInfluxDatabaseRecord.INFLUX_DB_ERROR_MESSAGE));
    }
    ...
    private void addTagByType(@Nullable final Object tagValue,
        ...
        addTagByType(tagValue, expectedValue, dataType, true, PutInfluxDatabaseRecord.REL_SUCCESS);
    }
    ...
    private void addTagByType(@Nullable final Object tagValue,
        ...
        if (PutInfluxDatabaseRecord.REL_FAILURE.equals(expectedRelations)) {
    ...
    private void addFieldByType(@Nullable final Object fieldValue,
        ...
        addFieldByType(fieldValue, expectedValue, dataType, true, PutInfluxDatabaseRecord.REL_SUCCESS);
    }
    ...
    private void addFieldByType(@Nullable final Object fieldValue,
        ...
        if (isValueExpected) {
            ...
            int expectedCount = expectedRelations.equals(PutInfluxDatabaseRecord.REL_FAILURE) ? 0 : 1;
