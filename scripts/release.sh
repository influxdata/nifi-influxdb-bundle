...
git add --all
git commit -am "prepare for next development iteration ${developmentVersion}"

echo
prompt_confirm "Do you want push the next development iteration ${developmentVersion}?" || exit 0
