...
git add --all
git commit -am "chore(release): release nifi-influx-database-bundle-${releaseVersion}"
...
echo "Next steps"
echo
echo "  1. wait for finish build on CircleCI: https://app.circleci.com/pipelines/github/influxdata/nifi-influxdb-bundle"
